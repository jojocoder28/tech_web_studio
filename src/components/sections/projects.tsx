          ...
          {projects.map((project) => {
            ...
            return (
              <Link key={project.id} href={project.link} target="_blank" rel="noopener noreferrer" className="group block">
                <Card className="overflow-hidden transition-all duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-2 hover:shadow-primary/10 bg-card/50 dark:bg-card/50 backdrop-blur-sm border-border/50 dark:border-border/50">
